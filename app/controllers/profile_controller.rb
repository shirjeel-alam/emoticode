class ProfileController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:username, :avatar_upload, :password, :password_confirmation, :profile_attributes => [ :id, :aboutme, :website, :gplus, :weekly_newsletter, :follow_mail ])
  end
